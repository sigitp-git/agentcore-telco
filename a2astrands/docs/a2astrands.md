# Agent-to-Agent (A2A) Protocol[¶](#agent-to-agent-a2a-protocol "Permanent link")
...
## What is Agent-to-Agent (A2A)?[¶](#what-is-agent-to-agent-a2a "Permanent link")
...
## Creating an A2A Server[¶](#creating-an-a2a-server "Permanent link")

### Basic Server Setup[¶](#basic-server-setup "Permanent link")
...
### Server Configuration Options[¶](#server-configuration-options "Permanent link")
...
### Advanced Server Customization[¶](#advanced-server-customization "Permanent link")
...
#### Configurable Request Handler Components[¶](#configurable-request-handler-components "Permanent link")
...
#### Path-Based Mounting for Containerized Deployments[¶](#path-based-mounting-for-containerized-deployments "Permanent link")
...
## A2A Client Examples[¶](#a2a-client-examples "Permanent link")

### Synchronous Client[¶](#synchronous-client "Permanent link")
...
### Streaming Client[¶](#streaming-client "Permanent link")
...
## Strands A2A Tool[¶](#strands-a2a-tool "Permanent link")
