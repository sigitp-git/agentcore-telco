# Agents as Tools with Strands Agents SDK[¶](#agents-as-tools-with-strands-agents-sdk "Permanent link")

## The Concept: Agents as Tools[¶](#the-concept-agents-as-tools "Permanent link")
...
## Key Benefits and Core Principles[¶](#key-benefits-and-core-principles "Permanent link")
...
## Strands Agents SDK Best Practices for Agent Tools[¶](#strands-agents-sdk-best-practices-for-agent-tools "Permanent link")
...
## Implementing Agents as Tools with Strands Agents SDK[¶](#implementing-agents-as-tools-with-strands-agents-sdk "Permanent link")
...
### Creating Specialized Tool Agents[¶](#creating-specialized-tool-agents "Permanent link")
...
### Creating the Orchestrator Agent[¶](#creating-the-orchestrator-agent "Permanent link")
...
### Real-World Example Scenario[¶](#real-world-example-scenario "Permanent link")
...
## Complete Working Example[¶](#complete-working-example "Permanent link")
