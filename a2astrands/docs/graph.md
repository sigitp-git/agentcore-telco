# Graph Multi-Agent Pattern[¶](#graph-multi-agent-pattern "Permanent link")
...
## How Graphs Work[¶](#how-graphs-work "Permanent link")
...
## Graph Components[¶](#graph-components "Permanent link")

### 1. GraphNode[¶](#1-graphnode "Permanent link")
...
### 2. GraphEdge[¶](#2-graphedge "Permanent link")
...
### 3. GraphBuilder[¶](#3-graphbuilder "Permanent link")
...
## Creating a Graph[¶](#creating-a-graph "Permanent link")
...
## Nested Multi-Agent Patterns[¶](#nested-multi-agent-patterns "Permanent link")
...
## Custom Node Types[¶](#custom-node-types "Permanent link")
...
## Multi-Modal Input Support[¶](#multi-modal-input-support "Permanent link")
...
## Asynchronous Execution[¶](#asynchronous-execution "Permanent link")
...
## Graph Results[¶](#graph-results "Permanent link")
...
## Input Propagation[¶](#input-propagation "Permanent link")
...
## Graphs as a Tool[¶](#graphs-as-a-tool "Permanent link")
...
## Common Graph Topologies[¶](#common-graph-topologies "Permanent link")

### 1. Sequential Pipeline[¶](#1-sequential-pipeline "Permanent link")
...
### 2. Parallel Processing with Aggregation[¶](#2-parallel-processing-with-aggregation "Permanent link")
...
### 3. Branching Logic[¶](#3-branching-logic "Permanent link")
