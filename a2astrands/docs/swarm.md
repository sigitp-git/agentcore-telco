# Swarm Multi-Agent Pattern[¶](#swarm-multi-agent-pattern "Permanent link")
...
## How Swarms Work[¶](#how-swarms-work "Permanent link")
...
## Creating a Swarm[¶](#creating-a-swarm "Permanent link")
...
## Swarm Configuration[¶](#swarm-configuration "Permanent link")
...
## Swarm Coordination Tools[¶](#swarm-coordination-tools "Permanent link")

When you create a Swarm, each agent is automatically equipped with special tools for coordination:

### Handoff Tool[¶](#handoff-tool "Permanent link")
...
## Shared Context[¶](#shared-context "Permanent link")
...
## Swarm Results[¶](#swarm-results "Permanent link")
...
## Swarm as a Tool[¶](#swarm-as-a-tool "Permanent link")
...
## Safety Mechanisms[¶](#safety-mechanisms "Permanent link")
