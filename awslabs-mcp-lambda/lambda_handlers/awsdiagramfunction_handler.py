"""
Lambda handler for AWS Diagram MCP Server using mcp_lambda library
"""
...
def lambda_handler(event: Dict[str, Any], context: LambdaContext) -> Dict[str, Any]:
    """
    Lambda handler for AWS Diagram MCP Server
            ...
            if not install_uv_if_needed():
                return {
                    "error": {
                        ...
                        "data": {
                            "server_id": "aws-diagram",
                            "server_name": "AWS Diagram MCP Server",
