"""
Lambda handler for AWS Pricing MCP Server using mcp_lambda library
"""
...
def lambda_handler(event: Dict[str, Any], context: LambdaContext) -> Dict[str, Any]:
    ...
    try:
            ...
            if not install_uv_if_needed():
                return {
                    "error": {
                        ...
                        "data": {
                            "server_id": "aws-pricing",
                            "server_name": "AWS Pricing MCP Server",
        ...
        server_config = {
            ...
            "env": {
                **{'FASTMCP_LOG_LEVEL': 'ERROR', 'AWS_REGION': 'us-east-1'},
