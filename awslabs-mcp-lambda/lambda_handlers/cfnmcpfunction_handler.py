"""
Lambda handler for AWS CloudFormation MCP Server using mcp_lambda library
"""
...
def lambda_handler(event: Dict[str, Any], context: LambdaContext) -> Dict[str, Any]:
    """
    Lambda handler for AWS CloudFormation MCP Server
            ...
            if not install_uv_if_needed():
                return {
                    "error": {
                        ...
                        "data": {
                            "server_id": "cfn-mcp",
                            "server_name": "AWS CloudFormation MCP Server",
