"""
Lambda handler for AWS CloudWatch Application Signals MCP Server using mcp_lambda library
"""
...
def lambda_handler(event: Dict[str, Any], context: LambdaContext) -> Dict[str, Any]:
    """
    Lambda handler for AWS CloudWatch Application Signals MCP Server
    ...
    try:
            ...
            if not install_uv_if_needed():
                return {
                    "error": {
                        ...
                        "data": {
                            "server_id": "cloudwatch-appsignals",
                            "server_name": "AWS CloudWatch Application Signals MCP Server",
        ...
        server_config = {
            ...
            "env": {
                **{'AWS_REGION': 'us-east-1', 'FASTMCP_LOG_LEVEL': 'ERROR'},
