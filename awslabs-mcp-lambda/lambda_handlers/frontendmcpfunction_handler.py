"""
Lambda handler for AWS Labs Frontend MCP Server using mcp_lambda library
"""
...
def lambda_handler(event: Dict[str, Any], context: LambdaContext) -> Dict[str, Any]:
    """
    Lambda handler for AWS Labs Frontend MCP Server
            ...
            if not install_uv_if_needed():
                return {
                    "error": {
                        ...
                        "data": {
                            "server_id": "frontend-mcp",
                            "server_name": "AWS Labs Frontend MCP Server",
