"""
Lambda handler for Git Repository MCP Server (Legacy) using mcp_lambda library
"""
...
def lambda_handler(event: Dict[str, Any], context: LambdaContext) -> Dict[str, Any]:
    """
    Lambda handler for Git Repository MCP Server (Legacy)
            ...
            if not install_uv_if_needed():
                return {
                    "error": {
                        ...
                        "data": {
                            "server_id": "git-repo",
                            "server_name": "Git Repository MCP Server (Legacy)",
