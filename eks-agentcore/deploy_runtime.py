#!/usr/bin/env python3
"""
Deployment script for EKS Agent to Amazon Bedrock AgentCore Runtime.
"""
        ...
        try:
            ...
            if existing_runtime:
                ...
                response = self.agentcore_client.create_agent_runtime(
                    ...
                    networkConfiguration={"networkMode": "PUBLIC"},
                    roleArn=execution_role_arn,
                    description="EKS Agent for AWS infrastructure and DevOps assistance"
                )
            ...
            # Save ARN to SSM
            put_ssm_parameter("/app/eksagent/agentcore/runtime_arn", agent_runtime_arn)
