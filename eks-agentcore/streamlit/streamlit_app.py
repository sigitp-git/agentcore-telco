#!/usr/bin/env python3
"""
Streamlit Frontend for AWS EKS Agent
A user-friendly web interface for interacting with the deployed EKS Agent.
"""
...
class StreamlitAgentInterface:
    """Streamlit interface for the EKS Agent."""
    ...
    def invoke_agent(self, prompt, session_id=None):
        ...
        try:
            ...
            with st.spinner('🤖 EKS Agent is thinking...'):
                # Invoke the agent
...
def main():
    ...
    # Header
    st.markdown('<h1 class="main-header">🚀 AWS EKS Agent</h1>', unsafe_allow_html=True)
    ...
    with st.sidebar:
        ...
        example_prompts = [
            ...
            "How do I implement cluster autoscaling in EKS?"
        ]
    ...
    <div style="text-align: center; color: #666; margin-top: 2rem;">
        <p>🚀 <strong>AWS EKS Agent</strong> | Powered by Amazon Bedrock & AgentCore Runtime</p>
