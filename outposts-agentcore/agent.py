...
class ConversationManager:
    ...
    def _list_all_mcp_tools(self) -> str:
        ...
        if aws_mcp_manager:
            try:
                ...
                result += "• Covers 50+ AWS services (Outposts, VPC, EC2, S3, etc.)\n"
    ...
    def _show_help(self) -> str:
        ...
        help_text += "\n"
        help_text += "🏢 **Outposts Expertise:**\n"
        help_text += "• Ask me anything about Outposts, hybrid cloud, edge computing, or AWS!"
