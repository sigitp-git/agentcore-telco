#!/usr/bin/env python3
"""
Script to invoke the deployed Outposts Agent in Amazon Bedrock AgentCore Runtime.
"""
...
# The Outposts Agent is deployed in us-east-1 region
...
class AgentRuntimeInvoker:
    ...
    def display_infrastructure_info(self):
        ...
        print("🏗️  Outposts Agent Infrastructure Information")
        print("=" * 50)
    ...
    def interactive_mode(self):
        ...
        print("🤖 Outposts Agent Interactive Mode")
        print("=" * 40)
...
• AWS Outposts expertise
• Hybrid cloud and edge computing guidance
...
• 'help' - Show this help
    ...
    def run_test_scenarios(self):
        ...
        test_scenarios = [
            {
                "name": "Basic Outposts Question",
                "prompt": "What is AWS Outposts and what are its main use cases?"
            },
            {
                "name": "Outposts Best Practices",
                "prompt": "What are the key considerations for Outposts deployment?"
            },
            {
                "name": "Web Search Test",
                "prompt": "Search for the latest AWS Outposts features"
            },
            {
                "name": "Troubleshooting Help",
                "prompt": "My Outposts rack is not connecting to AWS. What should I check?"
            }
        ]
