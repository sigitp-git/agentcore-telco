#!/usr/bin/env python3
"""
Amazon Bedrock AgentCore Runtime version of the Prometheus Agent.
...
def create_runtime_agent():
    ...
    try:
        ...
        agent = Agent(
            ...
            tools=tools,
            hooks=hooks,
            system_prompt="""You are a Prometheus Agent, an expert monitoring and observability assistant. You help with:
