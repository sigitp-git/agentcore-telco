#!/usr/bin/env python3
"""
Deployment script for Prometheus Agent to Amazon Bedrock AgentCore Runtime.
"""
...
class AgentRuntimeDeployer:
    ...
    def __init__(self, region=None):
        ...
        # Configuration
        self.repository_name = "prometheus-agent-runtime"
        self.agent_runtime_name = "prometheus_agent"
    ...
    def get_execution_role_arn(self):
        ...
        role_arn = get_ssm_parameter("/app/prometheusagent/agentcore/execution_role_arn")
        ...
        print(f"⚠️  No execution role found in SSM parameter: /app/prometheusagent/agentcore/execution_role_arn")
        ...
        put_ssm_parameter("/app/prometheusagent/agentcore/execution_role_arn", role_arn)
        ...
        try:
            ...
            if existing_runtime:
                ...
                response = self.agentcore_client.create_agent_runtime(
                    ...
                    networkConfiguration={"networkMode": "PUBLIC"},
                    roleArn=execution_role_arn,
                    description="Prometheus Agent for monitoring and observability assistance"
                )
            ...
            # Save ARN to SSM
            put_ssm_parameter("/app/prometheusagent/agentcore/runtime_arn", agent_runtime_arn)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Deploy Prometheus Agent to Amazon Bedrock AgentCore Runtime')
    ...
    print("🚀 Prometheus Agent Runtime Deployment")
    print("=" * 50)
    ...
    if args.test_only:
        ...
        runtime_arn = get_ssm_parameter("/app/prometheusagent/agentcore/runtime_arn")
        if runtime_arn:
