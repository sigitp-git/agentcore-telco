...
def create_devops_agent() -> Agent:
    ...
    return Agent(
        model=model,
        hooks=hooks,
        system_prompt="""You are AWS VPC agent. Help with AWS infrastructure and operations.
...
class ConversationManager:
    ...
    def start_conversation(self):
        ...
        print(f"\n🚀 {self.bot_name}: Ask me about VPC on AWS! Type 'exit' to quit.\n")
...
def setup_gateway_parameters():
    ...
    print("=" * 50)
    print(f"ℹ️  Using manually created gateway: {os.getenv('VPC_AGENT_GATEWAY_ID', 'vpc-agent-agentcore-gw-cjhql5d31l')}")
