#!/usr/bin/env python3
"""
Script to invoke the deployed VPC Agent in Amazon Bedrock AgentCore Runtime.
"""
...
# The VPC Agent is deployed in us-east-1 region
...
class AgentRuntimeInvoker:
    ...
    def display_infrastructure_info(self):
        ...
        print("🏗️  VPC Agent Infrastructure Information")
        print("=" * 50)
        
        # Get and display Gateway ID
        try:
            gateway_id = get_ssm_parameter("/app/vpcagent/agentcore/gateway_id")
            if gateway_id:
    ...
    def get_agent_runtime_arn(self):
        """Get the agent runtime ARN for VPC Agent from environment variable."""
        # Get VPC Agent runtime ARN from environment variable
    ...
    def interactive_mode(self):
        ...
        print("🤖 VPC Agent Interactive Mode")
        print("=" * 40)
...
• 'help' - Show this help
    ...
    def run_test_scenarios(self):
        ...
        test_scenarios = [
            {
                "name": "Basic VPC Question",
                "prompt": "What is Amazon VPC and what are its main components?"
            },
            {
                "name": "VPC Best Practices",
                "prompt": "What are the key principles of VPC security design?"
            },
            {
                "name": "Web Search Test",
                "prompt": "Search for the latest AWS networking features"
            },
            {
                "name": "Troubleshooting Help",
                "prompt": "My instances can't reach the internet. What should I check?"
            }
        ]
