#!/usr/bin/env python3
"""
Streamlit Frontend for AWS VPC Agent
A user-friendly web interface for interacting with the deployed VPC Agent.
"""
...
class StreamlitAgentInterface:
    """Streamlit interface for the VPC Agent."""
    ...
    def get_agent_gateway_id(self):
        """Get the agent gateway ID for VPC Agent from SSM parameter."""
        try:
    ...
    def invoke_agent(self, prompt, session_id=None):
        ...
        try:
            ...
            with st.spinner('🤖 VPC Agent is thinking...'):
                # Invoke the agent
...
def main():
    ...
    # Header
    st.markdown('<h1 class="main-header">🚀 AWS VPC Agent</h1>', unsafe_allow_html=True)
    ...
    <div style="text-align: center; color: #666; margin-top: 2rem;">
        <p>🚀 <strong>AWS VPC Agent</strong> | Powered by Amazon Bedrock & AgentCore Runtime</p>
